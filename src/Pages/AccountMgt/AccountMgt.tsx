...
import { paymentColData } from "@/Utils/constants";
...
const AccountMgt = () => {
  useUpdatePageName("Account Management");
  ...
  const { data, isLoading, refetch } = useGetPaymentsQuery(queryData);
